...
// page (objects/image.js) and pictures put on a page from a file (objects/inserted-image.js), each
// owning everything about turning its own kind of record into bytes.
//
...
const HANDLERS = new Map([[textRun.kind, textRun], [image.kind, image], [insertedImage.kind, insertedImage]]);
