...
- **Current cycle: 0.6.** One feature at a time, on the owner's instruction (2026-09-15). Done on `main`,
  not released: copy, paste and duplicate objects; cross-page and cross-document moves and paste
...
|---|---|---|
| Retyping, reflowing and replacing a pasted copy before it is saved | next | §3.2 |
