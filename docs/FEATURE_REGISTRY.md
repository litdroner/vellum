...
- **Current cycle: 0.6.** One feature at a time, on the owner's instruction (2026-09-15). Done on `main`,
  ...
  reflowing and replacing pasted copies (Editing). No version bump, push or release until the owner asks.
...
|---|---|---|
| Rotating text, free rotation | next | §3.2 |
