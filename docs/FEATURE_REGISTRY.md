...
- **Current cycle: 0.6.** One feature at a time, on the owner's instruction (2026-09-15). Done on `main`,
  ...
  written in (Editing). No version bump, push or release until the owner asks.
...
|---|---|---|
| Mixed formatting within one new text box (some words bold, another colour, another size): new text boxes are formatted as a whole today (see Editing) | planned | §3.2 |
