...
- **Current cycle: 0.6.** One feature at a time, on the owner's instruction (2026-09-15). Done on `main`,
  ...
  new text boxes with several lines, wrapping and formatting (Editing). No version bump, push or release until the owner asks.
